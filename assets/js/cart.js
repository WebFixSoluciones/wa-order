...
window.WRMModal = {
  ...
  updatePrice: function(){ var extra = 0; $('.wrm-extra-item').removeClass('selected'); $('.wrm-extra-check:checked').each(function(){ extra += parseFloat($(this).data('price'))||0; $(this).closest('.wrm-extra-item').addClass('selected'); }); var total = (this._basePrice + extra) * this._qty; $('#wrm-modal-price').text(fmt(total)); $('#wrm-modal-price-btn').text(fmt(total)); },
